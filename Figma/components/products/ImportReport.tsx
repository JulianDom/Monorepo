...
import { ImportResult } from '../ProductManagement';
...
export function ImportReport({ result, onBack }: ImportReportProps) {
          ...
          <div className="flex gap-3">
            ...
            <div className="space-y-1 flex-1">
              ...
              <p className="text-amber-700" style={{ fontSize: 'var(--text-sm)' }}>
                Se importaron {result.exitosos} productos correctamente, pero {result.errores} registros{' '}
        ...
        <Card className="border-l-4 border-l-green-500 bg-green-50 p-4">
          <div className="flex gap-3">
            ...
            <div className="space-y-1 flex-1">
              ...
              <p className="text-green-700" style={{ fontSize: 'var(--text-sm)' }}>
                Todos los productos se importaron correctamente sin errores.
              </p>
            </div>
          </div>
        </Card>
